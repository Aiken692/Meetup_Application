...
async function getStaticProps() {
  // fetch data from an API
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://Aiken692:Seeta.c0m1@cluster0.i0ndz.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
